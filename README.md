...
- **Lazy Fetch & State Caching**: Dynamic page routing loads data databases (`data.json`, `course.json`, `technical.json`, and `resource.json`) lazily depending on user navigation and caches them in memory.
